...
function assertThumbnail(result) {
...
const input = await readFile(new URL("fixture.png", import.meta.url));
...
console.log(
  `PASS: Node.js loaded @streamthumb/wasm ${streamthumbVersion()} and created a 32x32 PNG`,
);
